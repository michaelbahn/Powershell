...
$chartOutputType = "JPG"
$fileHTML = Join-Path $excelReportPath "report.html"
$fileHTMLtemplate = Join-Path $excelReportPath "report_template.html"
...
#loop through folders 
    foreach ($batchFolderDDF in $batchFoldersDDF)
    {
        ...
        Move-Item $batchFolderDDF.FullName $ddfFixArchivePath -Force
    }
}
...
#loop through folders 
    foreach ($batchFolderRBE in $batchFoldersRBE)
    {
        ...
        Move-Item $batchFolderRBE.FullName $rbeArchiveFolderPath -Force
    }
}
